...
function HUDLootScreen:init(hud, workspace, saved_lootdrop, saved_selected, saved_chosen, saved_setup)
  ...
  local name, level, rank, _ = MyHUD:information_by_peer(managers.network:session():local_peer())
  MyHUD:set_name_panel_text(peer_name, name, level, rank)
...
function HUDLootScreen:make_cards(peer, max_pc, left_card, right_card)
  ...
  local name, level, rank, _ = MyHUD:information_by_peer(peer)
  MyHUD:set_name_panel_text(peer_name, name, level, rank)
