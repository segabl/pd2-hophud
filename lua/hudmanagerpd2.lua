...
function HUDManager:add_teammate_panel(character_name, player_name, ai, peer_id)
  ...
  if unit then
    ...
    HopHUD:create_kill_counter(self._teammate_panels[id], id == HUDManager.PLAYER_PANEL and  managers.statistics:session_total_kills() - managers.statistics:session_total_civilian_kills())
  end
